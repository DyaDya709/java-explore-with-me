...
CREATE  INDEX IF NOT EXISTS categories_name_field ON categories (name);
CREATE INDEX IF NOT EXISTS compilations_name_field ON compilations (pinned);
CREATE INDEX IF NOT EXISTS Sevents_state_field ON events (state);
CREATE INDEX IF NOT EXISTS Sevents_event_date_field ON events (event_date);
CREATE INDEX IF NOT EXISTS Sevents_paid_field ON events (paid);
